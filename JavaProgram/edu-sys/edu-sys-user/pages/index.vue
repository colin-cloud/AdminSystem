                ...
                <li v-for="course in courses" :key="course.id">
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a :href="'/course/' + course.id"
                         :title="course.title" class="course-title fsize18 c-333">{{course.title}}</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">{{Number(course.price) === 0 ? '免费' : '收费'}}</i>
                      </span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 从数据库中获取8条热门课程
      getCourses() {
        course.getCountCourses().then(res => {
      ...
      // 从数据库中获取4个名师
      getTeachers() {
        teacher.getCountTeachers().then(res => {
