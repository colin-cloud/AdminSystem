        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img :src="teacher.avatar" style="width: 420px; height: 400px">
            </section>
            <h3 class="hLh30">
              <span class="fsize24 c-333">{{teacher.name}}&nbsp;{{levelStr}}</span>
            </h3>
            <section class="mt10">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      // 请求主讲课程
      this.getCoursesByTeacherId(id);
    },
    computed: {
      levelStr() {
        return Number(this.teacher.level) === 1 ? '高级讲师' : '首席讲师';
      }
    },
    methods: {
      // 根据id获取讲师
      ...
      getCoursesByTeacherId(id) {
        course.getCoursesByTeacherId(id).then(res => {
